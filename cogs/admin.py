...
Настройка VC для КВ, звания, расписание
"""
...
`!schedule` — посмотреть расписание (изменить нельзя)
    ...
    async def set_voice_channel(self, ctx: commands.Context, channel: discord.VoiceChannel):
        ...
        db_field, display_name = 'kv_vc_channel_id', 'КВ'
